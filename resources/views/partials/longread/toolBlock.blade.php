                        ...
                        <div class="item">
                            <div class="item__wrap">
                                <div class="image-holder">
                                    @if($item->slug)
                                        <a href="{{ route('page.tool', ['slug' => $item->slug]) }}" target="_blank">
                                        @endif
                                        {{--<img src="{{ \App\Helpers::getMediaPath($item->image) }}">--}}
                                ...
                                <div class="block_info">
                                    ...
                                    @if($item->slug)
                                        <a target="_blank" href="{{ route('page.tool', ['slug' => $item->slug]) }}" class="more_link">{{ t('page.show_inner') }}</a>
                                    @endif
