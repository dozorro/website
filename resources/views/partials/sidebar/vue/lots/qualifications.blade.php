<div class="tender-header__kicks tender-header-block" v-if="lots[lotId].awards">
    <div v-bind:class="{ 'tender-header__wrap tender-header__descr tender-header__kick': true, 'toggled': toggledLots[lotId].qualifications, 'loading': loadingLots[lotId].qualifications }">
        <button class="tender-header__descr-toggle" v-on:click="toggleRemote('qualifications', lotId)"></button>
        <spinner size="small"></spinner>
        <div class="block-title">{{ t('tender.protocol_disclosure') }}</div>
        <div class="tender-header_info__item" v-if="lots[lotId] && lots[lotId].remote.qualifications.other">
            <div class="tender-header__descr-item tender-header__descr-risks" v-if="lots[lotId].remote.qualifications.other.__awards_risks">
                <div class="risks-items">
                    <div class="risk-values">
                        <ul class="risk-item" v-for="title in lots[lotId].remote.qualifications.other.__awards_risks">
                            <li v-html="title"></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="kicks-container" v-if="lots[lotId].remote.qualifications.awards && lots[lotId].remote.qualifications.awards.length">
                <div v-for="award in lots[lotId].remote.qualifications.awards" v-bind:class="{ 'kick-item': true,  'positive': award.status == 'active', 'pending': award.status == 'pending', 'negative': (award.status != 'active' && award.status != 'pending') }">
            ...
            <div class="kicks-container" v-if="lots[lotId].remote.qualifications.bids && lots[lotId].remote.qualifications.bids.length">
                <div class="block-title">{{ t('indicators.bids.without_awards') }}</div>
                <div class="kick-item" v-for="bid in lots[lotId].remote.qualifications.bids">
                    <div class="kick-item-head">
                        <div class="kick-item-title">
