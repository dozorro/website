<div class="tender-header__public-monitoring" v-if="tender.complaints_total">
    <div v-bind:class="{'tender-header__wrap tender-header__descr': true, 'toggled': toggled.complaints, 'loading': loading.complaints}">
        <button class="tender-header__descr-toggle" v-on:click="toggleRemote('complaints')"></button>
        <spinner size="small"></spinner>
        <div class="block-title">{{ t('indicators.complaints') }} (@{{ tender.complaints_total }})</div>
        <div class="tender-header_info__item" v-if="tender.remote.complaints.complaints && tender.remote.complaints.complaints.complaints.length">
            <div class="tender-header__descr-item chat-block" v-for="(complaint, cKey) in tender.remote.complaints.complaints.complaints">
        ...
        <div class="tender-header_info__item" v-if="tender.remote.complaints.complaints && tender.remote.complaints.complaints.qualificationComplaints.length">
            <div class="tender-header__descr-item">
                <div class="detail-title">{{ t('indicators.qualification_complaints') }}</div>
            </div>
            <div class="tender-header__descr-item chat-block" v-for="(complaint, cKey) in tender.remote.complaints.complaints.qualificationComplaints">
                <div class="chat-item question" v-on:click="complaint.maxHeight+=tender.defaultMaxHeight">
                    <div class="chat-item-text" v-bind:style="{maxHeight: complaint.maxHeight + 'px'}" v-html="complaint.description"></div>
                    <div class="chat-item-info">
                        <div class="chat-item-time" v-html="complaint.authorId"></div>
        ...
        <div class="tender-header_info__item" v-if="tender.remote.complaints.complaints && tender.remote.complaints.complaints.awardComplaints.length">
            <div class="tender-header__descr-item">
                <div class="detail-title">{{ t('indicators.award_complaints') }}</div>
            </div>
            <div class="tender-header__descr-item chat-block" v-for="(complaint, cKey) in tender.remote.complaints.complaints.awardComplaints">
                <div class="chat-item question" v-on:click="complaint.maxHeight+=tender.defaultMaxHeight">
                    <div class="chat-item-text" v-bind:style="{maxHeight: complaint.maxHeight + 'px'}" v-html="complaint.description"></div>
                    <div class="chat-item-info">
                        <div class="chat-item-time" v-html="complaint.authorId"></div>
