...
@section('content')
                ...
                <div class="col-md-9">
                    <div class="c-blog__left">
                        <div class="c-one-new">
                            ...
                            @include('partials.news.full_post')
                        ...
                        <div class="likely" data-title="{{ $post->title }}" data-url="{{ route('page.news.post', ['slug' => $post->slug]) }}">
    ...
    <script type="text/javascript">
        var disqus_config = function () {
            this.page.url = '{{ route('page.news.post', ['slug' => $post->slug]) }}';
